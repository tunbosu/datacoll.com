 ...
 */
    $cta_content_type     = kuza_corporate_get_option( 'cta_content_type' );
    $cta_button_label       = kuza_corporate_get_option( 'cta_button_label' );
    $cta_button_url         = kuza_corporate_get_option( 'cta_button_url' );
    $cta_alt_button_label       = kuza_corporate_get_option( 'cta_alt_button_label' );
    $cta_alt_button_url         = kuza_corporate_get_option( 'cta_alt_button_url' );
    $cta_header_font_size = kuza_corporate_get_option( 'cta_font_size');
    $cta_content_font_size = kuza_corporate_get_option( 'cta_content_font_size');
...
?>
    ...
    <?php 
        $cta_id = kuza_corporate_get_option( 'cta_page' );
            $args = array (
            'post_type'     => 'page',
            'posts_per_page' => 1,
            'p' => $cta_id,
        ...
        ?>
                <div class="section-header">
                    ...
                    <h3 class="section-subtitle">
                        <?php $excerpt = kuza_corporate_the_excerpt( 15 );
