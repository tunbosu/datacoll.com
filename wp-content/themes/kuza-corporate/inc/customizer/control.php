...
class Kuza_Corporate_Dropdown_Chooser extends WP_Customize_Control{
	...
	public function render_content(){
		...
		?>
            <label>
                ...
                <select class="kuza-corporate-chosen-select" <?php $this->link(); ?>>
                    <?php
...
class Kuza_Corporate_Dropdown_Multiple_Chooser extends WP_Customize_Control{
    ...
    public function render_content(){
        ...
        ?>
            <label>
                ...
                <select class="kuza-corporate-chosen-select" multiple <?php $this->link(); ?>>
                    <?php
                    foreach ( $this->choices as $value => $label )
                        echo '<option value="' . esc_attr( $value ) . '"' . selected( $this->value(), $value, false ) . '>' . esc_html( $label ) . '</option>';
                    ?>
...
Class Kuza_Corporate_Customize_Horizontal_Line extends WP_Customize_Control {
    public $type = 'hr';
...
class Kuza_Corporate_Multi_Input_Custom_Control extends WP_Customize_Control {
    /**
     * Control type
     *
     * @var string
...
class Kuza_Corporate_Note_Control extends WP_Customize_Control {
